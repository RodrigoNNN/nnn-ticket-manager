...
export async function updateSpa(id, data) {
  const fields = {};
  for (const key of ['name', 'location', 'country', 'status', 'tier', 'monthly_budget', 'arrival_goal', 'arrival_goal_min', 'arrival_goal_target', 'payment_type', 'payment_schedule', 'ads_manager_url', 'onboarding_data', 'extra_fields', 'onboarded_via', 'tag']) {
